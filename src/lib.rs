...
//!
//! You can use the command-line tool to perform various operations on STL files.
//!
//! #### Parsing an STL File
//!
//! ```cmd
//! stl_parser.exe --output-format <OUTPUT_FORMAT> parse <INPUT>
//! ```
//!
//! #### Generating a Cube
//!
//! ```cmd
//! stl_parser.exe --output-format <OUTPUT_FORMAT> cube <A> <ORIGIN>
//! ```
//!
//! #### Generating a Cone
//!
//! ```cmd
//! stl_parser.exe --output-format <OUTPUT_FORMAT> cone <N> <R> <H> <ORIGIN>
//! ```
//!
pub mod utils;
